...
public class StockMain {
    public static void main(String[] args) {
        ...
        google.purchase(10, 1500.0);
        System.out.println("Shares after purchase: " + google.totalShares);
        System.out.println("Total cost after purchase: " + google.totalCost);
        google.clear();
        System.out.println("Shares after clear: " + google.totalShares);
        System.out.println("Total cost after clear: " + google.totalCost);
        // prevTest();
    }

    private static void prevTest() {
